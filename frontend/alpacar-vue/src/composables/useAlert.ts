...
export function useAlert() {
	 ...
	 */
	const handleNextTickShowAlert = (id: string) => {
	 ...
	 */
	const confirm = (message: string, title?: string, confirmText = "확인", cancelText = "취소"): Promise<boolean> => {
		return showAlert({
			type: "confirm",
			message,
			title,
...
export const { alert, alertSuccess, alertWarning, alertError, confirm } = globalAlert;
