...
<template>
	<div class="input-group">
		<input v-model="vehicleNumber" type="text" :class="inputClass" @input="handleVehicleNumberInput" @keydown="preventInvalidVehicleChars" />
		<div class="validation-message">
			<span v-if="vehicleNumber && !vehicleNumberValid" class="error"> 올바른 차량번호 형식이 아닙니다 (예: 12가3456) </span>
			<span v-else-if="vehicleNumberValid" class="success"> ✓ 올바른 형식입니다 </span>
		</div>
	</div>
</template>
