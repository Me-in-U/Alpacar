...
ALTER TABLE `Vehicle` ADD FOREIGN KEY (`model_id`) REFERENCES `VehicleModel` (`model_id`);

ALTER TABLE `ParkingAssignment` ADD FOREIGN KEY (`user_id`) REFERENCES `User` (`user_id`);

ALTER TABLE `ParkingAssignment` ADD FOREIGN KEY (`vehicle_id`) REFERENCES `Vehicle` (`vehicle_id`);

ALTER TABLE `ParkingAssignment` ADD FOREIGN KEY (`space_id`) REFERENCES `ParkingSpace` (`space_id`);

ALTER TABLE `VehicleEvent` ADD FOREIGN KEY (`vehicle_id`) REFERENCES `Vehicle` (`vehicle_id`);
