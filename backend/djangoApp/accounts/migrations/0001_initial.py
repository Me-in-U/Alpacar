    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(max_length=50, verbose_name='실명')),
                ('nickname', models.CharField(max_length=50, unique=True, verbose_name='닉네임')),
                ('phone', models.CharField(max_length=20, verbose_name='전화번호')),
                ('push_enabled', models.BooleanField(default=False, verbose_name='푸시 수신 여부')),
                ('score', models.IntegerField(default=0, verbose_name='주차 실력 점수')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('endpoint', models.URLField(verbose_name='엔드포인트 URL')),
                ('p256dh', models.CharField(max_length=255, verbose_name='P256DH 키')),
                ('auth', models.CharField(max_length=255, verbose_name='Auth 토큰')),
